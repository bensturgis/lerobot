...
class CrossLikSamplerConfig:
    ...
    scorer_model_path: str | Path | None = "outputs/train/flow_matching_pusht_02/checkpoints/last/pretrained_model"
...
class UncertaintySamplerConfig:
    ...
    composed_likelihood: ComposedLikSamplerConfig = field(default_factory=ComposedLikSamplerConfig)
    cross_likelihood: CrossLikSamplerConfig = field(default_factory=CrossLikSamplerConfig)
    likelihood: LikSamplerConfig = field(default_factory=LikSamplerConfig)
    epsilon_ball: EpsilonBallSamplerConfig = field(default_factory=EpsilonBallSamplerConfig)