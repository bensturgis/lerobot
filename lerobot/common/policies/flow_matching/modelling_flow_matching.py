...
class FlowMatchingPolicy(PreTrainedPolicy):
    ...
    def generate_actions(self, batch: dict[str, Tensor]) -> Tensor:
        ...
        if not self.training and self.uncertainty_sampler is not None:
            ...
            if (
                self.uncertainty_sampler_config.type == "cross_ensemble" or
                self.uncertainty_sampler_config.type == "cross_laplace"
            ):
            ...
            if self.uncertainty_sampler_config.type == "composed_sequence":
