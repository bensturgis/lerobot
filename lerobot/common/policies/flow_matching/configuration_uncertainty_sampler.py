...
@dataclass
class ComposedCrossLaplaceSamplerConfig:
...
class UncertaintySamplerConfig:
    ...
    composed_cross_laplace_sampler: ComposedCrossLaplaceSamplerConfig = field(
        default_factory=ComposedCrossLaplaceSamplerConfig
    )
